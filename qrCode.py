...
#Creating the window
wn = Tk()
wn.title('Sushant QR Code Generator')
wn.geometry('700x700')
...
def generateCode():
    ...
    messagebox.showinfo("Sushant QR Code Generator","QR Code is saved successfully!")
    
#Label for the window
headingFrame = Frame(wn,bg="azure",bd=5)
headingFrame.place(relx=0.15,rely=0.05,relwidth=0.7,relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code with Sushant", bg='azure', font=('Times',20,'bold'))
